import {adaptReviewToApp, adaptOfferToApp} from "../utils";
...
export const adaptedOffers = serverOffers.slice().map((offer) => adaptOfferToApp(offer));
export const adaptedReviews = serverReviews.slice().map((comment) => adaptReviewToApp(comment));
